...
#     test_table['F275W'][i] = synmag(model.spectrum[:, 0], model.spectrum[:, 1], filter_curve=filter_files[0])
#     test_table['F680N'][i] = synmag(model.spectrum[:, 0], model.spectrum[:, 1], filter_curve=filter_files[1])
...
#
#
# test_table.write('/home/ariel/Workspace/GASP/HST/Data/simulated_spectra/test_table.fits', overwrite=True)
