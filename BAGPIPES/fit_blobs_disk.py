...
for blob_id in blob_catalog['fit_id']:
    ...
    if run_flag:
        ...
        #
        # parametric_plots(fit, blob_id, blob_index, blob_catalog, plot_dir + detection + '_' + config + '_disk')
...
if run_flag is False:
    output_catalog.write(data_dir + 'disk_' + detection + '_' + config + '_bagpipes_results.fits', overwrite=True)
